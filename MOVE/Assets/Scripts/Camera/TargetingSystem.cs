...
public class TargetingSystem : MonoBehaviour
{
    ...
    [Header("Faction")]
    [Tooltip("Eigen faction — gebruikt om vijanden te detecteren via FactionComponent")]
    public FactionComponent.Faction ownFaction = FactionComponent.Faction.Player;
    ...
    Transform FindBestTarget(bool hittableOnly = false)
    {
        ...
        {
            // FactionComponent check — werkt ook zonder EnemyAI
            var fc = hit.GetComponent<FactionComponent>();
            if (fc != null && !fc.IsEnemyOf(ownFaction)) continue;
